...
async function main() {
    ...
    // Log a user in
    const loginSuccessful = atm.login(accountNumber, password);
    if (loginSuccessful) {
        ...
        switch (operation) {
            ...
            case "Make a withdrawal":
                ...
                const withdrawalAmount = Number(withdrawalAnswers.amount);
                // Make a withdrawal
                const withdrawalSuccessful = atm.withdraw(withdrawalAmount);
            ...
            case "Make a deposit":
                ...
                const depositAmount = Number(depositAnswers.amount);
                // Make a deposit
            ...
            case 'View transaction history':
                ...
                if (atm.currentAccount) {
                    ...
                    const transactionHistory = atm.currentAccount.getTransactionHistory();
